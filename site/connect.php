...
//	http_response_code(200);
	...
	*/
	...
	$protectionKey		= 'Test key'; //Ключ защиты
	$key1               = "0123456789ABCDEF"; //16-значный ключ шифрования ответа
	$key2               = "0123456789ABCDEF"; //16-значный ключ шифрования запроса.
